...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                 "12345678jakub"                                                                                  // set by application[DISCO_F413ZH]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                 WPA_WPA2                                                                                         // set by application[DISCO_F413ZH]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                     "JakubiNet"                                                                                      // set by application[DISCO_F413ZH]
